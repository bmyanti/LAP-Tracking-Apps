...
public class TM_Employee {
	...
	private static final String ROW_AUTHORITY_ID = "authority_id";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Employee";
		private static final int DB_VERSION=1;
		
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_EMPLOYEE_ID+" varchar PRIMARY KEY autoincrement," +
				""+ROW_USERNAME+"varchar ,"+ROW_PASSWORD+"varchar,"+ROW_AUTHORITY_ID+"varchar PRIMARY KEY," +
						""+ROW_GROUP_ID+"varchar PRIMARY KEY," +
		...
		public TM_Employee(Context ctx)
		{
		...
		public void addRow( String employee_id , 
				String username , String password, String authority_id ,
				String group_id,
				...
				)
		{
			...
			values.put(ROW_AUTHORITY_ID, authority_id);
			values.put(ROW_GROUP_ID, group_id);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_EMPLOYEE_ID, ROW_USERNAME, 
						ROW_PASSWORD, ROW_AUTHORITY_ID, ROW_GROUP_ID,
