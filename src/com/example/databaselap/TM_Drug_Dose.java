...
public class TM_Drug_Dose {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_DRUG_DOSE_ID+"varchar PRIMARY KEY autoincrement,"+ROW_DRUG_DOSE_DESCRIPTION+"varchar," +
		...
		public void addRow(  
				String drug_dose_id , String drug_dose_description ,
				...
				)
		{
			...
			values.put(ROW_DRUG_DOSE_ID, drug_dose_id);
			values.put(ROW_DRUG_DOSE_DESCRIPTION, drug_dose_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_DRUG_DOSE_ID, 
						ROW_DRUG_DOSE_DESCRIPTION,
