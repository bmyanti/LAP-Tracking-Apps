...
public class TM_Complaint_Status {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_COMPLAINT_STATUS_ID+"varchar PRIMARY KEY autoincrement,"+ROW_COMPLAINT_STATUS_DESCRIPTION+"varchar," +
		...
		public void addRow(  
				String complaint_status_id , String complaint_status_description ,
				...
				)
		{
			...
			values.put(ROW_COMPLAINT_STATUS_ID, complaint_status_id);
			values.put(ROW_COMPLAINT_STATUS_DESCRIPTION, complaint_status_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_COMPLAINT_STATUS_ID, 
						ROW_COMPLAINT_STATUS_DESCRIPTION,
