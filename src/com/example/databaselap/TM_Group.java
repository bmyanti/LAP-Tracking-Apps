...
public class TM_Group {
	...
	private static final String ROW_GROUP_DESCRIPTION = "group_description";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_GROUP";
		private static final int DB_VERSION=1;
		
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_GROUP_ID+" integer PRIMARY KEY autoincrement," +
				""+ROW_GROUP_DESCRIPTION+"text,"+ROW_CREATED_BY+"varchar,"+ROW_CREATED_TIME+"time,"+ROW_UPDATE_BY+"varchar,"+ROW_UPDATE_TIME+"time,)";
		...
		public void addRow( String group_id , String group_description,String created_by , String created_time ,
				String update_by , String update_time)
		{
			ContentValues values = new ContentValues();
			
			values.put(ROW_GROUP_ID, group_id);
			values.put(ROW_GROUP_DESCRIPTION, group_description);
