...
public class TR_Notification {
	...
	private static final String ROW_COUNT_LATE = "count_late";
	private static final String ROW_COUNT_ONTIME = "count_ontime";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_CHILD_ID+" varchar PRIMARY KEY autoincrement,"+ROW_EMPLOYEE_ID+" varchar PRIMARY KEY," +
				""+ROW_PARAM_GROUP+"varchar ,"+ROW_PARAM_ID+"varchar,"+ROW_COUNT_LATE+"varchar," +
						""+ROW_COUNT_ONTIME+"varchar," +
		...
		public TR_Notification(Context ctx)
		{
		...
		public void addRow( String child_id, String employee_id , 
				String param_group , String param_id , String count_late ,
				String count_ontime,
				...
				)
		{
			...
			values.put(ROW_COUNT_LATE, count_late);
			values.put(ROW_COUNT_ONTIME, count_ontime);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_CHILD_ID, ROW_EMPLOYEE_ID, ROW_PARAM_GROUP, 
						ROW_PARAM_ID, ROW_COUNT_LATE, ROW_COUNT_ONTIME,
