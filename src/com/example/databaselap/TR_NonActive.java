...
public class TR_NonActive {
	private static final String ROW_CHILD_ID = "child_id";
	private static final String ROW_REASON_ID = "reason_id";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TR_NONACTIVE";
		private static final int DB_VERSION=1;
		
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_CHILD_ID+" varchar PRIMARY KEY autoincrement," +
				""+ROW_REASON_ID+"VARCHAR,"+ROW_CREATED_BY+"VARCHAR,"+ROW_CREATED_TIME+"TIME,"+ROW_UPDATE_BY+"VARCHAR,"+ROW_UPDATE_TIME+"TIME,)";
		...
		public TR_NonActive(Context ctx)
		{
		...
		public void addRow( String child_id , String reason_id,
				...
				)
		{
			...
			values.put(ROW_REASON_ID, reason_id);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_CHILD_ID,ROW_REASON_ID, ROW_CREATED_BY,
