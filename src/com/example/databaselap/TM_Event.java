...
public class TM_Event {
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Event";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_EVENT_ID+"varchar PRIMARY KEY autoincrement,"+ROW_EVENT_DESCRIPTION+"text," +
		...
		public void addRow(  
				String event_id , String event_description ,
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_EVENT_ID, 
						ROW_EVENT_DESCRIPTION, ROW_START_DATE,ROW_END_DATE,
