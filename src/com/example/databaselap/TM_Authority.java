...
public class TM_Authority {

	private static final String ROW_AUTHORITY_ID = "authority_id";
	private static final String ROW_AUTHORITY_STATUS = "authority_status";

	private static final String ROW_MENU_ID = "menu_id";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Authority";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_AUTHORITY_ID+"varchar PRIMARY KEY autoincrement,"+ROW_AUTHORITY_STATUS+"varchar," +
						""+ROW_MENU_ID+"varchar PRIMARY KEY, " +
		...
		public TM_Authority(Context ctx)
		{
		...
		public void addRow(  
				String authority_id , String authority_status ,
				String menu_id, 
				...
				)
		{
			...
			values.put(ROW_AUTHORITY_STATUS, authority_status);
			values.put(ROW_MENU_ID, menu_id);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_AUTHORITY_ID, 
						ROW_AUTHORITY_STATUS, ROW_MENU_ID,
