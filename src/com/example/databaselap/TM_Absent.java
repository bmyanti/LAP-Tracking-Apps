...
public class TM_Absent {
	
	private static final String ROW_EVENT_ID = "event_id";
	private static final String ROW_EMPLOYEE_ID = "employee_id";
	private static final String ROW_CHILD_ID = "child_id";
	private static final String ROW_START_DATE = "start_date";
	private static final String ROW_EVENT_DESCRIPTION = "event_description";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Absent";
		private static final int DB_VERSION=1;
		
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_EVENT_ID+"varchar PRIMARY KEY autoincrement,"+ROW_EMPLOYEE_ID+" varchar PRIMARY KEY,"+ROW_CHILD_ID+" varchar PRIMARY KEY," +
				""+ROW_START_DATE+"date,"+ROW_EVENT_DESCRIPTION+"text,"+
		...
		public void addRow( String event_id , String employee_id , String child_id,
				 String start_date , String event_description ,
				...
				)
		{
			...
			values.put(ROW_EVENT_ID, event_id);
			values.put(ROW_CHILD_ID, child_id);
			values.put(ROW_EMPLOYEE_ID, employee_id);
			values.put(ROW_START_DATE, start_date);
			values.put(ROW_EVENT_DESCRIPTION, event_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ROW_EVENT_ID, ROW_CHILD_ID, ROW_EMPLOYEE_ID, 
						ROW_START_DATE, ROW_EVENT_DESCRIPTION,
