...
public class TM_Parent_Status {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_PARENT_STATUS_ID+" integer PRIMARY KEY autoincrement," +
				""+ROW_PARENT_STATUS_DESCRIPTION+"text,"+ROW_CREATED_BY+"varchar,"+ROW_CREATED_TIME+"time,"+ROW_UPDATE_BY+"varchar,"+ROW_UPDATE_TIME+"time,)";
		...
		public void addRow( String parent_status_id , String parent_status_description,
				String created_by , String created_time ,
				String update_by , String update_time )
		{
			ContentValues values = new ContentValues();
			
			values.put(ROW_PARENT_STATUS_ID, parent_status_id);
			values.put(ROW_PARENT_STATUS_DESCRIPTION, parent_status_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_PARENT_STATUS_ID,
						ROW_PARENT_STATUS_DESCRIPTION,
