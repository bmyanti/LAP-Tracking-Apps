...
public class TM_Move_Child_Group {
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Move_Child_Group";
		private static final int DB_VERSION=1;
		
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_DISTRICT_ID+"varchar PRIMARY KEY," +
				""+ROW_GROUP_ID+"varchar PRIMARY KEY,"+ROW_CHILD_ID+"varchar PRIMARY KEY autoincrement,"+
		...
		public TM_Move_Child_Group(Context ctx)
		{
		...
		public void addRow(  String district_id , String group_id , String child_id ,
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_DISTRICT_ID, ROW_GROUP_ID , ROW_CHILD_ID,
