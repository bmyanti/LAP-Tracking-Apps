...
public class TR_Cost_Facility {
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TR_Cost_Facility";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_CHILD_ID+"varchar PRIMARY KEY autoincrement,"+
				""+ROW_FACILITY_COST_ID+"varchar PRIMARY KEY ,"+ROW_LAB_RESULT_ID+"varchar PRIMARY KEY," +
		...
		public TR_Cost_Facility(Context ctx)
		{
		...
		public void addRow(  String child_id , String facility_cost_id ,
				...
				)
		{
			...
			values.put(ROW_LAB_RESULT_ID, lab_result_id);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_CHILD_ID,ROW_FACILITY_COST_ID, 
						ROW_LAB_RESULT_ID,
