...
public class TM_Reason {

	private static final String ROW_REASON_ID = "reason_id";
	private static final String ROW_REASON_DESCRIPTION = "reason_description";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Reason";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_REASON_ID+"varchar PRIMARY KEY autoincrement,"+ROW_REASON_DESCRIPTION+"varchar PRIMARY KEY," +
		...
		public void addRow(  
				String reason_id , String reason_description , 
				...
				)
		{
			...
			values.put(ROW_REASON_DESCRIPTION, reason_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_REASON_ID, 
						ROW_REASON_DESCRIPTION,
