...
public class TM_Menu {

	private static final String ROW_MENU_ID = "menu_id";
	private static final String ROW_MENU_DESCRIPTION = "menu_description";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Menu";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_MENU_ID+"varchar PRIMARY KEY autoincrement,"+ROW_MENU_DESCRIPTION+"varchar," +
		...
		public void addRow(  
				String menu_id , String menu_description ,
				...
				)
		{
			...
			values.put(ROW_MENU_DESCRIPTION, menu_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_MENU_ID, 
						ROW_MENU_DESCRIPTION,
