...
public class TM_Class {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_CLASS_ID+" integer PRIMARY KEY autoincrement," +
				""+ROW_CLASS_DESCRIPTION+"text,"+ROW_CREATED_BY+"varchar,"+ROW_CREATED_TIME+"time,"+ROW_UPDATE_BY+"varchar,"+ROW_UPDATE_TIME+"time,)";
		...
		public void addRow( String class_id , String class_description,String created_by , String created_time ,
				String update_by , String update_time )
		{
			ContentValues values = new ContentValues();
			
			values.put(ROW_CLASS_ID, class_id);
			values.put(ROW_CLASS_DESCRIPTION, class_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_CLASS_ID,
						ROW_CLASS_DESCRIPTION,ROW_CREATED_BY,ROW_CREATED_TIME, ROW_UPDATE_BY, ROW_UPDATE_TIME,
						}, null, null,
						null, null, null);
				cur.moveToFirst();
				if(!cur.isAfterLast())
