...
public class TM_Drug_Status {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_DRUG_STATUS_ID+"varchar PRIMARY KEY autoincrement,"+ROW_DRUG_STATUS_DESCRIPTION+"varchar," +
		...
		public void addRow(  
				String drug_status_id , String drug_status_description ,
				...
				)
		{
			...
			values.put(ROW_DRUG_STATUS_ID, drug_status_id);
			values.put(ROW_DRUG_STATUS_DESCRIPTION, drug_status_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_DRUG_STATUS_ID, 
						ROW_DRUG_STATUS_DESCRIPTION,
