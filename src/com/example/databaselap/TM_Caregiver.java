...
public class TM_Caregiver {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_CAREGIVER_ID+" integer PRIMARY KEY autoincrement," +
				""+ROW_CAREGIVER_DESCRIPTION+"text,"+ROW_CREATED_BY+"varchar,"+ROW_CREATED_TIME+"time,"+ROW_UPDATE_BY+"varchar,"+ROW_UPDATE_TIME+"time,)";
		...
		public void addRow( String caregiver_id , String caregiver_description,
				...
				)
		{
			...
			values.put(ROW_CAREGIVER_ID, caregiver_id);
			values.put(ROW_CAREGIVER_DESCRIPTION, caregiver_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_CAREGIVER_ID,
						ROW_CAREGIVER_DESCRIPTION,ROW_CREATED_BY,ROW_CREATED_TIME, ROW_UPDATE_BY, ROW_UPDATE_TIME
						}, null, null,
						null, null, null);
				cur.moveToFirst();
				if(!cur.isAfterLast())
