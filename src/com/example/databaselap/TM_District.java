...
public class TM_District {
	private static final String ROW_DISTRICT_ID = "district id";
	private static final String ROW_DISTRICT_DESCRIPTION = "district description";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" ("+ROW_DISTRICT_ID+" integer PRIMARY KEY autoincrement," +
				""+ROW_DISTRICT_DESCRIPTION+"text,"+ROW_CREATED_BY+"varchar,"+ROW_CREATED_TIME+"time,"+ROW_UPDATE_BY+"varchar,"+ROW_UPDATE_TIME+"time,)";
		...
		public void addRow( String district_id , 
				 String district_description,String created_by , String created_time ,
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{ ROW_DISTRICT_ID, 
						ROW_DISTRICT_DESCRIPTION,
