...
public class TM_Facility {
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_FACILITY_ID+"varchar PRIMARY KEY autoincrement,"+ROW_FACILITY_DESCRIPTION+"varchar," +
		...
		public void addRow(  
				String facility_id , String facility_description ,
				...
				)
		{
			...
			values.put(ROW_FACILITY_DESCRIPTION, facility_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_FACILITY_ID, 
						ROW_FACILITY_DESCRIPTION,
