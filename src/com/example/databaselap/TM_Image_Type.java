...
public class TM_Image_Type {

	private static final String ROW_IMAGE_TYPE_ID = "image_type_id";
	private static final String ROW_IMAGE_TYPE_DESCRIPTION = "image_type_description";
	...
	//mendeklarasikan NAMA_DB DAN TABLE DAN DATABASE VERSION
		...
		private static final String NAMA_TABEL="TM_Image_Type";
	...
	//mendeklarasikan membuat CREATE_TABLE = MEMBUAT TABLE"
		private static final String CREATE_TABLE ="create table "+NAMA_TABEL+" (" +
				""+ROW_IMAGE_TYPE_ID+"varchar PRIMARY KEY autoincrement,"+ROW_IMAGE_TYPE_DESCRIPTION+"varchar," +
		...
		public TM_Image_Type(Context ctx)
		{
		...
		public void addRow(  
				String image_type_id , String image_type_description ,
				...
				)
		{
			...
			values.put(ROW_IMAGE_TYPE_DESCRIPTION, image_type_description);
		...
		public ArrayList<ArrayList<Object>> ambilSemuaBaris()
		{
			...
			try {
				cur = db.query(NAMA_TABEL, 
						new String[]{  ROW_IMAGE_TYPE_ID, 
						ROW_IMAGE_TYPE_DESCRIPTION,
