...
public class LoginActivity extends Activity implements OnClickListener {
	...
	private class JSONLogin  extends AsyncTask<String, String, String>{
        ...
        //login.php returns true if logingrup, username, and password is equal to qwerty
        HttpPost httppost = new HttpPost("http://192.168.1.109:8000/XAMPP%20Project/loginlap.php");
        
        EditText grup = (EditText) findViewById(R.id.editlogingrup);
        String logingrup = grup.getText().toString();
		...
		protected String doInBackground(String... params) {
			...
			try {
	            ...
	            nameValuePairs.add(new BasicNameValuePair("logingrup", logingrup));
	            nameValuePairs.add(new BasicNameValuePair("username", username));
	            nameValuePairs.add(new BasicNameValuePair("password", password));
	            httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));

	            // Execute HTTP Post Request
	            Log.w("LAP", "Execute HTTP Post Request");
